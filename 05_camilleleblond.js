...
io.on('connection', function(socket) {
    ...
    socket.on('doServeron', doServeron);


    function doServeron(data) {
        console.log("doServeron");
        bulbOn();
        sendPinStatus();
        console.log(data);
    }
    socket.on('doServeroff', doServeroff);


    function doServeroff(data) {
        console.log("doServeroff");
        bulbOff();
        sendPinStatus();
        console.log(data);
    }
